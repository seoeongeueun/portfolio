  ...
  return (
    <main style={{ backgroundImage: `url(${Stars})` }}>
      ...
      <div
        ...
        key={props.current === 5 ? (reload ? 2 : 1) : 2}
      >
          ...
          <div className="scoreboard">
            <div className="bestPlayer">
              {change ? (
                ...
                <span style={{ marginBottom: "1rem" }}>MY INFO</span>
              )}
                  ...
                  <div className="boardContent">
                    {change ? (
                      ...
                      <span>
                        ...
                        <a
                          href="https://www.linkedin.com/in/seongeun-park-43b73a195/"
                          target="_blank"
                          rel="noreferrer"
                        >
                          <img
            ...
            {!change && (
              <div className="scoreboardName">
                ...
                <div className="nameLine1">
                  ...
                  <span
                    onClick={() => setName(name.substring(0, name.length - 1))}
                  >
                    DEL
                  </span>
                  {name?.length === 3 ? (
