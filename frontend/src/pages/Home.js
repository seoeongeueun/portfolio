...
function Home({
  ...
  useEffect(() => {
    if (text.length >= 50) {
      ...
      text.toLowerCase() === "about me" ||
      text.toLowerCase() === "aboutme"
    ) {
      setIndex(0);
      onSetMenu("about");
          ...
          <div className="main-screen">
            ...
            {showInput ? (
              <div className="userInputContainer">
                <span className="textTitle">TRY THE MINI KEYBOARD </span>
              ...
              <span className="intro">
                MY NAME IS SEONGEUN PARK AND WELCOME TO MY PAGE!
              </span>
            )}
            <div className="menus">
                ...
                <img
                  ...
                  style={
                    menu === "about"
                      ...
                      : { width: "25px", marginRight: "5px", display: "none" }
                  }
                />
                <span
                  className="start"
              ...
              <div className={musicOn ? "alienIcon" : "alienIconMute"}>
                {musicOn ? (
                  ...
                  <img
                    ...
                    src={Note2}
                    alt="note2"
                    style={{ width: "20px", marginRight: "5px", opacity: "0" }}
                  />
                )}
                {musicOn ? (
                  <img
                ...
                {musicOn ? (
                  ...
                  <img
                    src={Note}
                    alt="note"
                    style={{ width: "20px", marginRight: "2px", opacity: "0" }}
                  />
                )}
              </div>
            )}
