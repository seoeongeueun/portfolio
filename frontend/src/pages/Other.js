                ...
                <div className='otherPageBody'>
                    {checked ? <div className='otherPageDesc'>
                        {props.lang === 'Korean' ? <div className='descTitle'>
                                                ...
                                                심즈3와 세컨드라이프 게임 전용 유저 커스텀 제작 아이템 (CC)를 만들고 배포하는게 취미였습니다.</span>}
                                                {page === 1 && <span>옆의 예시는 제가 제작한 아이템을 홍보하기 위해 만든 이미지의 일부입니다. 아이템 자체 뿐만 아니라 이미지에도 신경을 쓸 수록 아이템의 다운로드 수도 높았고, 유저들의 반응도 좋았습니다.</span>}
                                                {page === 2 && <span>주로 옷을 제작했지만 데코 아이템이나 헤어를 만들기도 했습니다.</span>}
                                                {page === 3 && <span>아이템을 디자인하고 3d 메쉬를 제작하고 다른 유저들 교류하며 많이 배우고 다양한 기술을 공부하는 좋은 경험이었습니다.</span>}
                                                {page === 4 && <span>튜토리얼을 찾아보고, 다른 사람들에게 질문하고, 여러 문제에 부딪히면서, 독학하는 것을 겁내지 않게 되는 계기가 되었습니다.</span>}
                                                </div>
                                                <span style={{float: 'right', marginTop: '1rem', fontSize: '1rem' }}>{page+1}/{5}</span>
                                              </div>
                            : <div className='descTitle'>
                                ...
                                <div className='descBody'>
                                    ...
                                    {page === 1 && <span>These are some of the promotional images I made for my items. </span>}
                                    {page === 2 && <span>Mostly I made clothing items, but sometimes decorative objects too.</span>}
                                    {page === 3 && <span>It was a fun opportunity to study new skills and I had a lot of fun designing and creating meshes, making promotional images, and connecting with other users. </span>}
                                    {page === 4 && <span>Looking up tutorials online, asking other people questions, and going through lots of trial and error helped me get used to studying by myself.</span>}
                                </div>
                                <span style={{float: 'right', marginTop: '1rem', fontSize: '1rem'}}>{page+1}/{5}</span>
                            </div>}
                    </div>
                ...
                <div className='gameboyContainer'>
                  ...
                  <div className='gameboy'>
                          ...
                          <div className='gameboyBottomDeco'>
                              ...
                              <div className='gameboyGreen'>
                                  ...
                                  {(checked && !loading) && <div className='screenImages'>
                                      {page === 0 && <><img src={Project1} alt='projectPic'/><img src={Project2} alt='projectPic'/></>}
                                      {page === 1 && <img src={Project5} alt='projectPic'/>}
                                      {page === 2 && <img src={Project4} alt='projectPic'/>}
                                      {page === 3 && <><img src={Project3} alt='projectPic'/><img src={Project6} alt='projectPic'/></>}
                                      {page === 4 && <><img src={Project6} alt='projectPic'/><img src={Project7} alt='projectPic'/></>}
                      ...
                      <div className='gameboyButtons'>
                          <div className='buttonMoveContainer' onClick={() => checked && setPage(page >= 4 ? 0 : page+1)}>
                              <div className='buttonMove'/>
                              <div className='buttonMoveBox'/>
                          </div>
                          <div className='miniButtons' onClick={() => checked && setPage(page >= 4 ? 0 : page+1)}>
