                ...
                <div className='otherPageBody'>
                    {checked ? <div className='otherPageDesc'>
                        {props.lang === 'Korean' ? <div className='descTitle'>
                                                ...
                                                {page === 1 && <span>옆의 예시는 제가 제작한 아이템을 홍보하기 위해 만든 이미지의 일부입니다. </span>}
                                                {page === 2 && <span>주로 옷을 제작했지만 가끔 데코 아이템이나 헤어도 만들었습니다.</span>}
                                                {page === 3 && <span>아이템을 디자인하고 3d 메쉬를 제작하고 다른 유저들 교류하며 많이 배우고 다양한 기술을 공부하는 좋은 경험이었습니다.</span>}
                                                {page === 4 && <span>튜토리얼을 찾아보고, 다른 사람들에게 질문하고, 다양한 문제에 부딪히면서, 독학하는 것을 겁내지 않게 되는 첫 계기가 되었습니다.</span>}
                                                </div>
