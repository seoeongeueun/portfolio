                        ...
                        {index1 === 2 && <div className='image1'>
                            ...
                            {lang === 'English' ? <div className='image1Desc'>
                                ...
                                : <div className='image1Desc'>
                                    ...
                                    <div className='image1DescContent'>
                                        <span>유저가 다른 유저의 플랫폼에서 퀴즈를 푸는 화면입니다. 저는 이 페이지의 프론트엔드와 백엔드 작업을 둘 다 담당했습니다. 모든 질문은 객관식으로 이루어져 있으며, 각 질문에는 30초의 타이머가 있습니다. 시간 제한 내에 답을 고르지 않으면 자동으로 오답처리 됩니다.</span>
                        ...
                        {index1 === 3 && <div className='image1'>
                            ...
                            {lang === 'English' ? <div className='image1Desc'>
                                ...
                                : <div className='image1Desc'>
                                    ...
                                    <div className='image1DescContent'>
                                        <span>퀴즈 점수와 결과를 보여주는 페이지입니다. 프론트엔드와 백엔드 둘 다 작업했습니다. 맞춘 질문의 갯수, 정답을 맞춰 얻은 포인트, 그리고 힌트와 타이머로 차감된 포인트가 표시됩니다. </span>
                        ...
                        {index1 === 4 && <div className='image1'>
                            ...
                            {lang === 'English' ? <div className='image1Desc'>
                                ...
                                : <div className='image1Desc'>
                                    <span style={{marginBottom: '0.3rem'}}>메인 페이지</span>
                                    <div className='image1DescContent'>
                                        <span>프로필을 꾸밀 수 있는 아이템인 아이콘과 칭호를 구매할 수 있는 상점 페이지입니다. 프론트엔드와 백엔드 둘 다 작업했습니다. 아이템을 구매하면 포인트가 차감됩니다. Preview를 눌러 헤더에서 아이템을 장착하면 어떤 모습일지 프로필을 미리보기 할 수 있습니다.</span>
                        ...
                        {index1 === 6 && <div className='image1'>
                            ...
                            {lang === 'English' ? <div className='image1Desc'>
                                ...
                                : <div className='image1Desc'>
                                    ...
                                    <div className='image1DescContent'>
                                        <span>전체 유저 랭킹을 보여주는 순위표 페이지입니다. 저는 프론트엔드와 백엔드 작업을 둘 다 했습니다. 순위표는 기본적으로 레벨 순위로 정렬한 하나의 큰 표입니다. 레벨, 정확도, 플레이 횟수 열을 클릭해서 해당 조건대로 재정렬할 수 있습니다.  왼쪽과 오른쪽 컴포넌트로 나누어 설정 및 영역은 각각 적용되고, 위젯과 스티커는 왼쪽 영역 내에서 자유롭게 배치할 수 있습니다.</span>
